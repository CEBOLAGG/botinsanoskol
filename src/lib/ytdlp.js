...
export async function ytMeta(url) {
  try {
 ...
 */
export async function ytDownload(url, spec, timeoutMs = 180_000) {
...
export async function ytSize(url, spec) {
  try {
 ...
 */
export async function ytDirectUrl(url, spec) {
  try {
...
export async function ytCleanup(dir) {
  if (!dir) return;
  try {
